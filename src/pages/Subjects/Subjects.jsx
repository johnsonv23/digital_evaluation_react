...
function Subjects() {
  ...
  const validate = () => {
    ...
    if (Number(form.passingMarks) > Number(form.maxMarks))
      newErrors.passingMarks = "Passing > Max not allowed";
    ...
    <div className="faculty-container">
      ...
      <div className="table-container">
          ...
          <tbody>
            {currentRecords.map((s) =>
              editId === s.subjectId ? (
                <tr key={s.subjectId}>
                  <td>{s.subjectId}</td>
                  <td><input name="subjectCode" value={editForm.subjectCode} onChange={handleEditChange} /></td>
                  <td><input name="subjectName" value={editForm.subjectName} onChange={handleEditChange} /></td>
                  <td><input name="credits" value={editForm.credits} onChange={handleEditChange} /></td>
                  <td><input name="maxMarks" value={editForm.maxMarks} onChange={handleEditChange} /></td>
                  <td><input name="passingMarks" value={editForm.passingMarks} onChange={handleEditChange} /></td>
                  <td>
                ...
                <tr key={s.subjectId}>
                  ...
                  <td>
                    ...
                    <button className="btn delete-btn" onClick={() => handleDelete(s.subjectId)}>Delete</button>
                  </td>
                </tr>
              )
            )}
        ...
        <div className="pagination">
          ...
          <span>Page {currentPage}</span>
          <button disabled={indexOfLast >= filteredData.length} onClick={() => setCurrentPage(currentPage + 1)}>Next</button>
        </div>
      </div>
    </div>
  );
